...
% Format section titles like IEEE (e.g., I. INTRODUCTION)
\usepackage{titlesec}

\titleformat{\section}
  {\centering\normalfont\fontsize{10pt}{12pt}} % 10pt bold, centered
...
% Converts section numbers from regular numbers to roman numerials
\renewcommand{\thesection}{\Roman{section}}

% Set the space between cols
\setlength{\columnsep}{0.25in}
\setlength{\hsize}{3.275in}
...
\begin{center}
    ...
    \fontsize{12pt}{10pt}{\selectfont Davi Dantas, Evan Kasky, Youssef Samwel, Pablo Rodriguez, Timothy Ogg, Nicolas Sayed\par}
