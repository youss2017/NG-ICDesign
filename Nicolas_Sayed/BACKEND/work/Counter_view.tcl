...
create_library_set -name slow_lib_125C \
     -timing {../libs/NangateOpenCellLibrary_typical.lib \
              ../OpenRam/openram_150/sram_150b_512_1rw_freepdk45_TT_1p1V_25C_vdd_vss.lib}
...
create_constraint_mode -name fast_mode -sdc_files {../Synthesis/outputs/Counter_sdc.sdc}
create_constraint_mode -name slow_mode -sdc_files {../Synthesis/outputs/Counter_sdc.sdc}
