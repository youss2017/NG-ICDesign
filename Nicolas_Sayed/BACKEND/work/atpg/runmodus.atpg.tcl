...
build_model \
    -cell	 rapid_x_cpu \
    -techlib	 ../libs/LibParsing/NangateOpenCellLibrary_typical.lib,../OpenRam/openram_150/sram_150b_512_1rw_freepdk45.v \
    -designsource	 $WORKDIR/rapid_x_cpu.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/rapid_x_cpu.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 rapid_x_cpu_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_rapid_x_cpu_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 rapid_x_cpu_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_rapid_x_cpu_atpg
...
check_log log_commit_tests_FULLSCAN_rapid_x_cpu_atpg
