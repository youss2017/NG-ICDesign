...
# Generated on: Thu Jan 30 20:34:54 EST 2025 (Fri Jan 31 01:34:54 UTC 2025)
...
set logfile fv/execute_logic/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/execute_logic -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/net/cadence/installs/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/net/cadence/installs/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/net/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 rapid_pkg.sv
delete_search_path -all -design -golden
add_search_path ../rtl/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 execute_logic.sv
elaborate_design -golden -root {execute_logic} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/execute_logic/fv_map.v.gz
elaborate_design -revised -root {execute_logic}
...
#add_name_alias fv/execute_logic/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.execute_logic.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.execute_logic.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.execute_logic.rtl.fv_map.rpt
