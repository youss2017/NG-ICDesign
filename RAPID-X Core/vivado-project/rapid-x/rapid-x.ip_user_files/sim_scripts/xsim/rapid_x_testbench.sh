...
#
# Script generated by Vivado on Fri Mar 07 20:16:09 -0500 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rapid_x_testbench.sh
...
#
# Usage        : rapid_x_testbench.sh
#                rapid_x_testbench.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rapid_x_testbench.sh [-reset_run]
#                rapid_x_testbench.sh [-reset_log]
#                rapid_x_testbench.sh [-help]
#
...
# script info
echo -e "rapid_x_testbench.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rapid_x_testbench.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot rapid_x_testbench xil_defaultlib.rapid_x_testbench xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rapid_x_testbench -key {Behavioral:sim_1:Functional:rapid_x_testbench} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rapid_x_testbench.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rapid_x_testbench.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rapid_x_testbench.sh [-help]\n\
Usage: rapid_x_testbench.sh [-step]\n\
Usage: rapid_x_testbench.sh [-lib_map_path]\n\
Usage: rapid_x_testbench.sh [-reset_run]\n\
Usage: rapid_x_testbench.sh [-reset_log]\n\
Usage: rapid_x_testbench.sh [-keep_index]\n\
Usage: rapid_x_testbench.sh [-noclean_files]\n\n\
