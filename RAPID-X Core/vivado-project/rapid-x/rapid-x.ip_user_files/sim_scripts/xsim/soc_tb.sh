...
#
# Script generated by Vivado on Tue Apr 08 20:58:06 -0400 2025
...
#
# Usage        : soc_tb.sh
#                soc_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                soc_tb.sh [-reset_run]
#                soc_tb.sh [-reset_log]
#                soc_tb.sh [-help]
#
...
# script info
echo -e "soc_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./soc_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot soc_tb xil_defaultlib.soc_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim soc_tb -key {Behavioral:sim_1:Functional:soc_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./soc_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: soc_tb.sh [-help]\n\
Usage: soc_tb.sh [-step]\n\
Usage: soc_tb.sh [-lib_map_path]\n\
Usage: soc_tb.sh [-reset_run]\n\
Usage: soc_tb.sh [-reset_log]\n\
Usage: soc_tb.sh [-keep_index]\n\
Usage: soc_tb.sh [-noclean_files]\n\n\
