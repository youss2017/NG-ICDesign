...
HD_PWD='C:/Users/youssef/Documents/NG-ICDesign/RAPID-X Core/vivado-project/rapid-x/rapid-x.runs/blk_cpu_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_cpu_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_cpu_mem.tcl
