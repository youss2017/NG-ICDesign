...
HD_PWD='C:/Users/youssef/Documents/NG-ICDesign/RAPID-X Core/vivado-project/rapid-x/rapid-x.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rapid_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rapid_soc.tcl -notrace
