...
#                script (type 'blk_vram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_vram xil_defaultlib.glbl -o blk_vram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_vram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_vram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_vram_simv.daidir vcs_lib c.obj)
