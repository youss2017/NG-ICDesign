...
#
# Script generated by Vivado on Fri Apr 11 00:13:16 -0400 2025
...
# script info
echo -e "blk_vram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_vram xil_defaultlib.blk_vram xil_defaultlib.glbl -log elaborate.log
}
