...
HD_PWD='C:/Users/youssef/Documents/mcu-soc/rapidx_basys3/rapidx_basys3.runs/blk_vram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_vram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_vram.tcl
